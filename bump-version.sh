...
if [ -f VERSION ]; then
	...
	echo "" >> tmpfile
	echo "All notable changes to the Pipeline Manager UI project will be documented in this file." >> tmpfile
    echo "" >> tmpfile
	echo "## [$INPUT_STRING] - $NOW" >> tmpfile
	echo "" >> tmpfile
	echo "### TBD" >> tmpfile
	echo "" >> tmpfile
	tail --lines=+5 CHANGELOG.md >> tmpfile
	echo "" >> tmpfile
    ...
    echo -e "${ERROR_FLAG} Could not find a VERSION file."
    read RESPONSE
fi
